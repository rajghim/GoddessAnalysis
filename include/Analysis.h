...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           QQQ5Mul;
   Int_t           QQQ5Upstream[128];   //[QQQ5Mul]
   ...
   Bool_t          foundGRETINA;
   Int_t           xtalsMul;
   Float_t         xtals_xlab[128];   //[xtalsMul]
   Float_t         xtals_ylab[128];   //[xtalsMul]
   Float_t         xtals_zlab[128];   //[xtalsMul]
   Float_t         xtals_cc[128];   //[xtalsMul]
   Float_t         xtals_edop[128];   //[xtalsMul]
   Float_t         xtals_edopMaxInt[128];   //[xtalsMul]
   Float_t         xtals_edopSeg[128];   //[xtalsMul]
   Float_t         xtals_edopXtal[128];   //[xtalsMul]
   Int_t           xtals_crystalNum[128];   //[xtalsMul]
   Int_t           xtals_quadNum[128];   //[xtalsMul]
   Float_t         xtals_t0[128];   //[xtalsMul]
   Long64_t        xtals_timestamp[128];   //[xtalsMul]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Run0073_combined.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Run0073_combined.root");
      }
...
void Analysis::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("GRETINATimeStamp", &GRETINATimeStamp, &b_GRETINATimeStamp);
   fChain->SetBranchAddress("foundGRETINA", &foundGRETINA, &b_foundGRETINA);
   fChain->SetBranchAddress("xtalsMul", &xtalsMul, &b_xtalsMul);
   fChain->SetBranchAddress("xtals_xlab", xtals_xlab, &b_xtals_xlab);
   fChain->SetBranchAddress("xtals_ylab", xtals_ylab, &b_xtals_ylab);
   fChain->SetBranchAddress("xtals_zlab", xtals_zlab, &b_xtals_zlab);
   fChain->SetBranchAddress("xtals_cc", xtals_cc, &b_xtals_cc);
   fChain->SetBranchAddress("xtals_edop", xtals_edop, &b_xtals_edop);
   fChain->SetBranchAddress("xtals_edopMaxInt", xtals_edopMaxInt, &b_xtals_edopMaxInt);
   fChain->SetBranchAddress("xtals_edopSeg", xtals_edopSeg, &b_xtals_edopSeg);
   fChain->SetBranchAddress("xtals_edopXtal", xtals_edopXtal, &b_xtals_edopXtal);
   fChain->SetBranchAddress("xtals_crystalNum", xtals_crystalNum, &b_xtals_crystalNum);
   fChain->SetBranchAddress("xtals_quadNum", xtals_quadNum, &b_xtals_quadNum);
   fChain->SetBranchAddress("xtals_t0", xtals_t0, &b_xtals_t0);
   fChain->SetBranchAddress("xtals_timestamp", xtals_timestamp, &b_xtals_timestamp);
   Notify();
}
